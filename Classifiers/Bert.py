...
class Bert_Classifier(pl.LightningModule):
    ...
    def train_model(self, training_set, dev_set, test_set, num_epochs):
        ...
        self.trainer = pl.Trainer(gpus=self.argdict['gpus'], max_epochs=num_epochs, precision=16, accelerator="dp")#, persistent_workers=True)#, enable_checkpointing=False)
        ...
        final = self.trainer.test(self, self.test_loader)
        print(final)

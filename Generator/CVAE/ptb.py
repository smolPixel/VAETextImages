...
from Generators.utils import OrderedCounter
...
class PTB(Dataset):
    ...
    def __init__(self, data_dir, split, create_data, **kwargs):
        ...
        self.raw_data_label_path=os.path.join(data_dir, 'ptb.'+split+'.label.txt')
    ...
    def _create_data(self):
        ...
        file_label=open(self.raw_data_label_path, 'r')
        with open(self.raw_data_path, 'r') as file:

            for i, (line, label) in enumerate(zip(file, file_label)):

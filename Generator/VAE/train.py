...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                ...
                #         # print(batch['input'])
                #         # print('----------SAMPLES----------')
                #         print(datasets['train'].get_i2w())
                #         print(batch['target'])
                #         print(batch['input'])
                #         print(*idx2word(samples, i2w=datasets['train'].get_i2w(), pad_idx=datasets['train'].get_w2i()['<pad>']), sep='\n')
                #         print(*idx2word(batch['input'], i2w=datasets['train'].get_i2w(), pad_idx=datasets['train'].get_w2i()['<pad>']), sep='\n')
                #         model.train()
    ...
    for split in splits:
        ...
        dataset=torch.zeros(len(data_loader.dataset), params['latent_size'])
